    ...
    public partial class TakeCareOfAPlant : Form , IMyServiceCallback
    {
        ...
        public void ServerConnect()
        {
         ...
         //   MyServiceCallback serviceCallback = new MyServiceCallback();
            ...
            netTcpFactory = new DuplexChannelFactory<IServicesWCF>(this, netTcp, new EndpointAddress(
        ...
        {
            SendOrPostCallback refreshList = delegate
            {
                getAvailablePlants();
                getSubscribedPlants();
            };
            _SyncContext.Post(refreshList, null);
        }
