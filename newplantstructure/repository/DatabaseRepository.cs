...
namespace LastDropMainServer
{
    class DatabaseRepository
    {
        ...
        public void addPlant(Plant plant)
        {
            ...
            cmd.Parameters.Add("@coolDown", plant.CoolDown);
            cmd.Parameters.Add("@dryValue", plant.DryValue);
            cmd.Parameters.Add("@humidValue", plant.HumidValue);
            cmd.Connection = con;
            cmd.ExecuteNonQuery();
            con.Close();
            plantList.Add(plant);
        ...
        public void updatePlant(Plant oldPlant, Plant newPlant)
        {
            ...
            cmd.Parameters.Add("@coolDown", newPlant.CoolDown);
            cmd.Parameters.Add("@dryValue", newPlant.DryValue);
            cmd.Parameters.Add("@humidValue", newPlant.HumidValue);
            cmd.ExecuteNonQuery();
            con.Close();
