    ...
    class DatabaseRepository
    {
        ...
        public void addPlant(Plant plant)
        {
            ...
            try
            {
                con.Open();
                SqlCommand cmd = new SqlCommand();
                cmd.CommandText = " INSERT INTO Plants VALUES (@name , @plantstate , @amount, @coolDown, @dryValue, @humidValue, @plantID)";
                cmd.Parameters.AddWithValue("@name", plant.Name);
        ...
        public void updatePlant(Plant oldPlant, Plant newPlant)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = "UPDATE Plants set Name=@plantName, PlantState=@status, WaterAmount=@waterAmount, CoolDown=@coolDown, DryValue=@dryValue, HumidValue=@humidValue, PlantID=@plantID where Name=@oldPlantName";
                ...
                cmd.Parameters.AddWithValue("@plantID", newPlant.PlantID);
                cmd.ExecuteNonQuery();
                con.Close();
